...
mtx = sparse.spdiags([np.linspace(2.0, 3.0, num=50),np.linspace(2.0, 30.0, num=50), np.linspace(2.0, 3.0, num=50)], [-1,0, 1], 10, 10)
# print mtx.todense()

rhs = np.array(np.linspace(2.0, 3.0, num=10))
# print mtx
