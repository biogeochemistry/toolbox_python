...
eq1 = TransientTerm(var=var1) == (DiffusionTerm(coeff=diffCoeff,var=var1))
                          # + PowerLawConvectionTerm(coeff=convCoeff,var=var1))
                          # - var2*var1)
print eq1
# eq2 = TransientTerm(var=var2) == (DiffusionTerm(coeff=5,var=var2) 
                          # + PowerLawConvectionTerm(coeff=[-1],var=var2)
                          # - var2*var1)
                         # 2*
